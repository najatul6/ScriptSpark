    ...
    <div className="min-h-[calc(100vh-64px)] p-6 bg-slate-900 flex flex-col items-center font-sans">
      <div className="w-full max-w-3xl bg-white/5 backdrop-blur-md border border-white/10 p-8 rounded-3xl shadow-xl animate__animated animate__fadeIn">
        ...
        <header className="mb-8">
          ...
          <p className="text-slate-400 mt-1">Transform tough client messages into winning opportunities.</p>
        </header>
        ...
        <div className="mb-4">
          <label className="block text-xs font-bold text-slate-500 uppercase tracking-widest mb-2">The Client Said:</label>
          <textarea
        ...
        {reply && (
          <div className="mt-8 animate__animated animate__fadeInUp">
            <div className="flex justify-between items-center mb-2 px-1">
              <h3 className="text-purple-400 text-sm font-semibold">Recommended Response:</h3>
              <button 
